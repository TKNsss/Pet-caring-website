...
const NotFound = () => {
  return (
    <div className="@container flex h-screen flex-col items-center justify-center bg-white text-center">
      <div className="max-w-[32.5rem]">
        <h1 className="font-Monserrat flex justify-center font-bold text-black">
          <span className="relative left-5 z-1 self-end text-7xl @3xl:text-9xl">
            4
          </span>
          <img src={cryIcon} className="z-100 h-24 w-24 @3xl:h-36 @3xl:w-36" />
          <span className="relative right-5 z-1 self-end text-7xl @3xl:text-9xl">
            4
          </span>
        </h1>
        <h2
          className="font-Monserrat mt-4 text-[1.375rem] font-bold text-[#232323]"
