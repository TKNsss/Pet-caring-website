...
const Introduction2 = () => {
  return (
    <div className="web-container @container">
      <section className="px-[2.25rem] py-12">
        <div className="grid grid-cols-1 items-center gap-15 md:grid-cols-2">
          ...
          <div className="font-Monserrat">
            ...
            <p className="mb-8 text-[18px] text-txt-2">
            ...
            <ul className="list-inside list-disc space-y-2 text-gray-700">
              <li className="mb-5 flex items-start text-[18px]">
              ...
              <li className="mb-5 flex items-start text-[18px]">
                <FaCircleCheck color="#F7CE72" className="mt-2 mr-1" />
                If your home has an access code, it will only be available to
                your sitter during scheduled service hours
              </li>
            </ul>
          </div>
