...
import footerHome from "../../../assets/footer_left.png";
import footerHome2 from "../../../assets/footer_right.png";
      ...
      <div class="relative bg-[#5A3BB3] text-white">
        ...
        <div class="lg flex h-[150px] items-center justify-between sm:h-[200px] lg:h-[280px] xl:h-[320px]">
          ...
          <img
            src={footerHome}
            alt="Cool Dog"
            class="z-1 h-[150px] w-[155px] object-cover sm:h-[230px] sm:w-[250px] lg:h-[350px] lg:w-[400px] xl:h-[370px] xl:w-[380px]"
          />
          ...
          <img
            src={footerHome2}
            alt="Happy Cat"
            class="z-10 mt-4 hidden object-cover md:mt-0 lg:block lg:h-[330px] lg:w-[300px] xl:h-[380px] xl:w-[350px]"
          />
        </div>
      </div>
