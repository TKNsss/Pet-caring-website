...
const quality = () => {
  return (
    <section className="relative bg-[#EBE8FC] py-18">
      <svg
      ...
      <div className="mx-auto max-w-screen-xl px-4">
        ...
        {/* Khối nội dung: 4 mục */}
        <div className="mt-10 grid grid-cols-1 sm:gap-10 md:grid-cols-2 lg:grid-cols-4">
          {/* Mục 1 */}
          <div className="flex flex-col mb-5 items-start text-left">
            <BsAwardFill size={60} color="#6F32BE" />
            <h3 className="mt-4 mb-2 text-2xl font-bold text-[#6F32BE] lg:mt-10">
              Well-trained Staffs
            </h3>
            <p className="font-Monserrat text-xl mt-2 lg:mt-5">
          ...
          <div className="flex flex-col mb-5 items-start text-left">
            ...
            <p className="font-Monserrat text-xl mt-2 lg:mt-5">
              We use only the safest cleaning products formulated specifically
