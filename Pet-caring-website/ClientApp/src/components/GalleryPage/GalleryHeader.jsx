    ...
    <div style={{ backgroundColor: "#5A3BB3" }} className="relative flex flex-col lg:flex-row w-screen m-0">
      ...
      <div className="text-center lg:w-2/5">
          <div className="lg:inline-block">
            <h1 style={{fontFamily: "chewy"}} className="text-center text-[40px] leading-[67.95px] sm:text-[50px] md:text-[60px] lg:mt-[82px] lg:text-[42px] xl:mt-[72px] xl:text-left xl:text-[52px]">OUR HAPPY MOMENTS</h1>
            <p className="text-center text-[20px] mt-[2%] leading-[30px] pb-[30px] md:text-[30px] lg:text-[20px] lg:mt-[30px] xl:text-left xl:mt-[30px]">We bring joys and loves to your besties</p>
            <button style={{fontFamily: "chewy"}} className='block text-center text-[23px] leading-[30.05px] w-[227px] h-[54px] bg-[#E4813A] text-white m-auto mb-[10%] rounded-[25px] shadow-[1px_4px_5px_rgba(0,0,0,0.3)] lg:m-0 lg:mt-[30px]'>
