...
import dogFooter from "../../../assets/dog_footer.png";
import catFooter from "../../../assets/cat_footer.png";
      ...
      <div class="relative bg-[#5A3BB3] text-white">
        ...
        <div class="lg flex h-[150px] items-center justify-between sm:h-[200px] lg:h-[280px] xl:h-[320px]">
          ...
          <img
            src={dogFooter}
            alt="Cool Dog"
            class="h-[150px] w-[155px] object-cover sm:h-[230px] sm:w-[250px] lg:h-[257px] lg:w-[290px] xl:h-[320px] xl:w-[350px]"
          />
          ...
          <img
            src={catFooter}
            alt="Happy Cat"
            class="lg: mt-4 hidden object-cover md:mt-0 lg:block lg:h-[257px] lg:w-[350px] xl:h-[320px] xl:w-[440px]"
          />
        </div>
      </div>
