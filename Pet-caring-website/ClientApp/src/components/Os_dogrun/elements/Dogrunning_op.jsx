...
import Dogwalk from "../../../assets/poppyRun.jpg";
import Singlewalk from "../../../assets/dogRun.jpg";
import Groupwalk from "../../../assets/groupRun.jpg";
          ...
          <div className="flex w-full flex-col items-start lg:flex-row lg:items-stretch">
            ...
            <div className="w-full flex-1 px-6 lg:relative lg:w-1/2">
              <img
                src={Dogwalk}
                alt="Puppy Walk"
                className="top-0 min-h-[300px] left-0 h-full w-full rounded-lg object-cover lg:absolute lg:rounded-l-lg lg:px-0 lg:rounded-r-none"
              />
            </div>
