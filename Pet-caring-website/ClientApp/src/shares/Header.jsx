      ...
      <div className="flex">
        <div className="web-container @container">
          <div className="m-0 flex flex-col px-[2.25rem] lg:flex-row">
            <div className={`lg:w-3/5 ${id === "Whpc" ? "ml-auto" : ""}`}>
              <div
                className={`@5xl:mt-[82px] ${id === "Whpc" ? "@5xl:ml-8" : ""}`}
              >
                <h1
                  className={`mt-4 text-4xl ${id === "Whpc" ? "text-fourth" : "text-[#F1F1F1]"} @3xl:text-[55px] @5xl:mt-0`}
                  dangerouslySetInnerHTML={{ __html: title }}
                />
                <p
                  className={`mt-4 font-Poppins max-w-[715px] text-xl leading-[30px] ${id === "Whpc" ? "text-third" : "text-[#F1F1F1]"} lg:mt-[30px] lg:w-[46vw] lg:text-[23px] xl:mt-[30px]`}
        ...
        <img
          src={headerImg}
          alt="pet-pic"
          className={`absolute top-0 ${id === "Whpc" ? "left-0 rounded-tr-[199px] rounded-br-[279px]" : "right-0 rounded-tl-[199px] rounded-bl-[279px]"} hidden h-full w-[40%] object-cover object-right lg:block`}
        />
      </div>
    </div>
  );
